...
float get_k(string mat, float temp){
    ...
    for(auto it = pairs.begin(); it != pairs.end(); ++it, ++i){
        if( it->first < temp ){
            prev = *it;
        }else{
